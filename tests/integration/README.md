...
(current fleet build 0.10.145 — the spine test pins the exact expected
...
| # | Name | Asserts |
|---|------|---------|
| 1 | `test_1_plugin_load_and_version_pin` | `amx_ktp_versions` lists KTPMatchHandler at the version pinned in `EXPECTED_KTPMATCHHANDLER_VERSION` (currently 0.10.145). Catches the "source bumped, deployed binary stale" class. |
