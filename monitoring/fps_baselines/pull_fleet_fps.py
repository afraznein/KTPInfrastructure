...
SERVERS = {
    'atlanta': {'host': '74.91.121.9',     'user': 'dodserver', 'password': 'ktp'},
    'dallas':  {'host': '74.91.126.55',    'user': 'dodserver', 'password': 'ktp'},
    'denver':  {'host': '66.163.114.109',  'user': 'dodserver', 'password': 'ktp'},
    'newyork': {'host': '74.91.123.64',    'user': 'dodserver', 'password': 'ktp'},
    'chicago': {'host': '172.238.176.101', 'user': 'dodserver', 'password': 'ktp'},
}
