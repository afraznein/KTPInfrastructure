...
> ⚠️ The leaderboard figures in `KTPR_CALCULATION.md` predate #196 and were not regenerated by it;
> its bR0M/hildebrand reversal is attributed there to `tw_kd` and break smoothing. The text below is
