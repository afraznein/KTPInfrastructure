...
#
# Replaced by: build_awards.py's weekend-positions award, generated with role/slot.
#
...
_RETIRED = ("fix_positions_award.py is retired. It patches awards.json sections that no longer "
