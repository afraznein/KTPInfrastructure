...
#
# Replaced by: award_catalog.py, where Difficulty: Tourist and its 30-kill floor are definitions rather than a one-off swap.
#
...
_RETIRED = ("swap_tourist_award.py is retired. It patches awards.json sections that no longer "
